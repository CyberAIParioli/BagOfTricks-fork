...
python -u main.py \
    ...
    2>&1 | tee -ai ./exp_logs/main_vicuna/harmful_bench_50/self_reminder/PAIR/main_vicuna_self_reminder/2_split0_harmful_bench_50_self_reminder_PAIR_vicuna-7b-v1.5_$(date +\%Y\%m\%d_\%H\%M\%S).txt
