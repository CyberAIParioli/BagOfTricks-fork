...
python -u main.py \
    ...
    2>&1 | tee -ai ./exp_logs/main_vicuna/MaliciousInstruct_100/None_defense/PAIR/main_vicuna_none_defense/8_split0_MaliciousInstruct_100_None_defense_PAIR_vicuna-7b-v1.5_$(date +\%Y\%m\%d_\%H\%M\%S).txt
